...
- uncredited freebooting: downloading my short-form or long-form videos and uploading them directly to your own channel with zero mention of @TheRealRetroBloxxer anywhere.
- silent compilations: dumping my original footage or project visuals into generalized compilation videos without any explicit on-screen or description credit.
- impersonating: creating profiles using the RetroBloxxer name or branding assets to re-post existing media and farm engagement.
# 4. correctly crediting 
to ensure your content is in good standing, match your attribution layout to your delivery format:

| Platform | Required Attribution Style |
| :------- | :------------------------- |
