...
trigger = """
  - huge crashout and swearing
  - immense government bullshit
"""
...
yeah, child safety (sarcasm induced)

## age checks 
parents love it, the government loves it, everyone loves it.

it's the shitass tech that detects your age using your personal data (looking at you Roblox.)

### does it even work?
no shit.

example: you are 21 and that flags u as 9

it's useless as shit

# games 
we literally LEFTED (meme) all of the world bc "we need a representative for games passing 100k concurrent players"

consequences? million turkish lira fine ORRRR bandwidth narrowing (making the platform useless basically)

# VPNs
here's the thing. we used VPNs to bypass all of this 

but will it be possible anymore?
...
well, guess this sucks (and i hope i don't find myself in Silivri Prison)